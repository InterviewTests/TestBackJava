...
public class GastosQueryControllerTest {
    ...
    @Test
    public void deveConsultarUltimosGastosComSucesso() throws Exception {
    ...
    @Test
    public void deveConsultarGastosPorDataComSucesso() throws Exception {
        List<GastosDTO> dtoList = enhancedRandom.objects(GastosDTO.class, 10).collect(Collectors.toList());
        Page<GastosDTO> page = new PageImpl<>(dtoList);
    ...
    @Test
    public void deveTratarDataInvalida() throws Exception {
        List<GastosDTO> dtoList = enhancedRandom.objects(GastosDTO.class, 10).collect(Collectors.toList());
        Page<GastosDTO> page = new PageImpl<>(dtoList);
