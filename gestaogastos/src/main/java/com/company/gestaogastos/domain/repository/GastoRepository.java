...
//	List<Gasto> findByCodigousuario(Integer codigousuario);
//	Page<Gasto> findByCodigousuario(Integer codigousuario, Pageable pageRequest);
    ...
    public List<Gasto> findByDescricaoCategoria(
    			@Param("codigousuario") Integer codigousuario,
    ...
    public List<Gasto> findByNomeCategoria(
    			@Param("codigousuario") Integer codigousuario,
